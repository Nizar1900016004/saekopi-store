            ...
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <form class="inline-block" action="{{ route('transactions.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="group relative">
                                    <a href="#" @click="detail = true">
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('storage/' . $pd->product->image_url) }}"
                                        ...
                                        <div class="mt-4 flex justify-between">
                                            <div>
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">{{ $pd->product->description }}
                                                </p>
                                            </div>
                                            <p class="text-sm font-medium text-gray-900">{{ $pd->product->price }}
                                            </p>
                                        </div>
                                    </a>
